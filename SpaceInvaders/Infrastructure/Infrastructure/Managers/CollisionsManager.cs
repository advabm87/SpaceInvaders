...
namespace Infrastructure
{
    ...
    public class CollisionsManager : GameService, ICollisionsManager
    {
        ...
        {
            this.Game.Services.RemoveService(typeof(ICollisionsManager));
        ...
        public void RemoveObjectFromMonitoring(ICollidable i_Collidable)
        {
            if (this.m_Collidables.Contains(i_Collidable))
            {
                i_Collidable.PositionChanged -= collidable_PositionChanged;
                i_Collidable.Disposed -= collidable_Disposed;
                this.m_Collidables.Remove(i_Collidable);
            }
        }
        ...
        public virtual bool CheckCollisionPerPixel(ICollidable i_Source)
        {
            return false;
        }
    }
